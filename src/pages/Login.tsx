...
const Login = () => {
  ...
  return (
    <div className="min-h-screen hero-gradient flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary via-purple-500 to-accent">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-between p-12">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold text-primary-foreground lg:text-5xl">
              Welcome back to the pulse of campus events.
            </h1>
            <p className="text-lg text-primary-foreground/80 max-w-md">
              Log in to manage your events, track registrations, and engage with your community in real-time.
            </p>
          </div>

          {/* Testimonial */}
          <div className="glass-card bg-primary-foreground/10 border-primary-foreground/20 p-6">
            <p className="text-primary-foreground/90 italic">
              "EventPulse transformed how we run campus events. The real-time features are game-changing."
            </p>
            <div className="mt-4 flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-primary-foreground/30" />
              <div>
                <div className="font-medium text-primary-foreground">Sarah Chen</div>
                <div className="text-sm text-primary-foreground/70">Student Council, MIT</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-2xl font-bold md:text-3xl">Sign in to your account</h2>
